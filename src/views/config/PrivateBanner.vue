  ...
  <div class="page">
    ...
    <el-dialog :visible.sync="editDg" title="编辑/新增banner">
      ...
      >
        ...
        <el-form-item label="上传图片" prop="big_image">
          <p>750*400像素，支持PNG,JPG格式，小于1M</p>
          <p>banner大图</p>
          <upload-img
            :width="200"
            :height="100"
            v-model="currItem.big_image"
            :disabled="time"
          ></upload-img>
        </el-form-item>
